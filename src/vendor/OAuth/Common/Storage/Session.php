...
class Session implements TokenStorageInterface
{
    ...
    public function storeJSessionCookie($cookie)
    {
        $this->jSessionIDCookie = $cookie;
    }

    public function retrieveJSessionCookie()
    {
        return $this->jSessionIDCookie;
    }
