...
class CurlClient extends AbstractClient
{
    ...
    public function addCurlParameter($param, $value)
    {
    ...
    public function retrieveResponse(
        ...
        $headers = array();
        curl_setopt($ch, CURLOPT_HEADERFUNCTION, function($curl, $headerStr) use (&$headers) {
            $len = strlen($headerStr);
            if ($header = trim($headerStr)) {
                $headers[] = $header;
            }
        ...
        if (false === $response) {
            ...
            $this->lastRequest['error'] = "$errNo: $errStr";
